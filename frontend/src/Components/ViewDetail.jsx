  ...
  return (
    <div className="max-w-md mx-auto bg-white shadow-md rounded-md p-8">
      ...
      <div className="flex justify-end mt-6">
        <button onClick={handleEdit} className="w-[88px] h-[38px] bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded mr-2">
          Edit
        </button>
        <button onClick={handleDelete} className="w-[88px] h-[38px] bg-red-500 hover:bg-red-600 text-white py-2 px-4 rounded">
          Delete
        </button>
      </div>
    </div>
